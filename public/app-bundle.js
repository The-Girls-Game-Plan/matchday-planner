...
const ALL_POSITIONS = ['GK', 'CD', 'CD-R', 'CD-L', 'RB', 'LB', 'CM', 'CM-R', 'CM-L', 'CDM', 'CAM', 'RW', 'LW', 'ST', 'ST-R', 'ST-L'];
...
const calculateEqualMinutes = (settings, players) => {
  ...
  const updatedPlayers = players.map(player => {
    if (player.role === 'GK') {
      return {
        ...player,
        minutes: isPermanentGK ? matchDuration : 0
      };
    }
...
const generateAutomaticPlan = (settings, playersWithMinutes) => {
  ...
  let outfieldPlayers = playersWithMinutes.filter(p => p.role !== 'GK' && p.minutes > 0).sort((a, b) => a.minutes - b.minutes);
...
const PlayerInputRow = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "text-xs font-semibold w-6 text-center text-gray-500"
    ...
    value: ""
  }, "Pref. Pos."), allPositions.map(pos => /*#__PURE__*/React.createElement("option", {
    key: pos,
    value: pos
  }, pos))), isChampionship && /*#__PURE__*/React.createElement("select", {
    ...
    value: ""
  }, "Sec. Pos."), allPositions.map(pos => /*#__PURE__*/React.createElement("option", {
    key: pos,
    value: pos
  }, pos))), isChampionship && /*#__PURE__*/React.createElement("input", {
    type: "number",
...
}, name.split(' ').map(n => n[0]).join('')), /*#__PURE__*/React.createElement("span", {
...
const PositionVisualizer = ({
  ...
  const visualPlayers = startingOutfieldPlayers.map((player, index) => {
    ...
    return /*#__PURE__*/React.createElement(PlayerCircle, {
      key: player.id,
      name: player.name,
      position: position,
      isGK: false,
  ...
  if (gkPlayer) {
    const {
      y,
      x
    } = getPositionCoordinates('GK');
    visualPlayers.push(/*#__PURE__*/React.createElement(PlayerCircle, {
      key: gkPlayer.id,
      name: gkPlayer.name,
      position: "GK",
      isGK: true,
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "relative w-full h-96 border-4 border-green-800 bg-green-700/80 rounded-xl overflow-hidden shadow-inner"
  }, /*#__PURE__*/React.createElement("div", {
    className: "absolute inset-0 border-white border-2 m-4 rounded-lg opacity-80"
  }, /*#__PURE__*/React.createElement("div", {
    className: "absolute top-1/2 left-1/2 w-20 h-20 border-white border-2 rounded-full transform -translate-x-1/2 -translate-y-1/2 opacity-80"
  }), /*#__PURE__*/React.createElement("div", {
    className: "absolute top-0 left-1/2 w-40 h-10 border-white border-2 transform -translate-x-1/2"
  }), /*#__PURE__*/React.createElement("div", {
    className: "absolute bottom-0 left-1/2 w-40 h-10 border-white border-2 transform -translate-x-1/2 -scale-y-100"
  })), visualPlayers, /*#__PURE__*/React.createElement("div", {
    className: "absolute bottom-2 right-2 text-xs font-semibold text-white bg-black/50 p-1 rounded"
...
const SubscriptionBadge = ({
  ...
  if (tier === 'Premiership') {
    ...
    icon = /*#__PURE__*/React.createElement(Star, {
      className: "w-4 h-4 text-white fill-current mr-1"
    });
    text = 'Premiership';
  } else if (tier === 'Championship') {
    color = COLORS.SKY_BLUE;
    icon = /*#__PURE__*/React.createElement(Unlock, {
...
const App = () => {
  ...
  const handleLoadSquad = squadData => {
    const loadedPlayers = squadData.map((p, i) => ({
      ...p,
      id: p.id || crypto.randomUUID()
    }));
    setSettings(prev => ({
      ...prev,
      squadSize: loadedPlayers.length
    }));
  ...
  const handleGeneratePlan = () => {
    if (activePlayers.length < outfieldSpots + 1) {
      // Need at least GK + outfield spots
  ...
  if (error) {
    return /*#__PURE__*/React.createElement("div", {
      className: "text-red-600 p-4 bg-red-100 rounded-lg m-4"
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "flex flex-col md:flex-row justify-between items-center pb-6 border-b-4 mb-6",
    style: {
  ...
  }, "The Girls' Game Planner")), /*#__PURE__*/React.createElement(SubscriptionBadge, {
    ...
    className: "inline w-4 h-4 mr-1 align-sub"
  }), " User ID: ", /*#__PURE__*/React.createElement("span", {
    className: "font-mono text-xs"
  }, userId)), /*#__PURE__*/React.createElement("div", {
    ...
    className: "block"
  }, "Game Format (XvX)"), /*#__PURE__*/React.createElement("select", {
    value: settings.gameFormat,
    onChange: e => setSettings(p => ({
      ...p,
      gameFormat: e.target.value
    })),
  ...
  }, Object.keys(FORMATIONS).map(f => /*#__PURE__*/React.createElement("option", {
    key: f,
    value: f
  }, f))), /*#__PURE__*/React.createElement("label", {
    className: "block pt-2"
  }, "Match Duration (min)"), /*#__PURE__*/React.createElement("input", {
    type: "number",
  ...
  }, "Duration is set automatically based on FA guidelines for ", settings.gameFormat, "."), settings.gameFormat === '5v5' && /*#__PURE__*/React.createElement("div", {
    className: "pt-2"
  }, /*#__PURE__*/React.createElement("label", {
    className: "block"
  }, "5v5 Match Periods"), /*#__PURE__*/React.createElement("div", {
    ...
    className: "mr-2"
  }), " Halves (2 x 20 min)"), /*#__PURE__*/React.createElement("label", {
    className: "flex items-center"
  }, /*#__PURE__*/React.createElement("input", {
    type: "radio",
    ...
    onChange: () => setSettings(p => ({
      ...p,
      matchPeriods: 'Quarters'
    })),
    className: "mr-2"
  }), " Quarters (4 x 10 min)"))), /*#__PURE__*/React.createElement("label", {
    className: "block pt-2"
  }, "Squad Size"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    ...
    className: "block pt-2"
  }, "Goalkeeper Rotation"), /*#__PURE__*/React.createElement("div", {
    className: "flex space-x-4"
  }, /*#__PURE__*/React.createElement("label", {
    className: "flex items-center"
  }, /*#__PURE__*/React.createElement("input", {
    ...
    className: "mr-2"
  }), " Permanent GK"), /*#__PURE__*/React.createElement("label", {
    className: "flex items-center"
  }, /*#__PURE__*/React.createElement("input", {
    type: "radio",
    checked: !settings.isPermanentGK,
    ...
    className: "mr-2"
  }), " Rotating GK")), /*#__PURE__*/React.createElement("label", {
    className: "block pt-2"
  }, "Formation (Outfield Players)"), /*#__PURE__*/React.createElement("select", {
  ...
  }, Object.keys(formationsAvailable).map(f => /*#__PURE__*/React.createElement("option", {
    key: f,
    value: f
  }, f))))), isChampionship && /*#__PURE__*/React.createElement("div", {
  ...
  }), " Squad Management"), /*#__PURE__*/React.createElement("p", {
    className: "text-sm mb-4",
    style: {
      color: COLORS.NAVY_BLUE
    }
  }, isPremiership ? 'Unlimited Squad Saves' : `Save up to ${maxSquads} Squads`, " (Current: ", savedSquads.length, ")"), /*#__PURE__*/React.createElement(Button, {
    onClick: handleSaveSquad,
    disabled: isSavingLoading || !isPremiership && savedSquads.length >= maxSquads,
    color: COLORS.SKY_BLUE
  }, isSavingLoading ? 'Saving...' : 'Save Current Squad'), /*#__PURE__*/React.createElement("div", {
    className: "mt-4 space-y-2 max-h-48 overflow-y-auto"
  }, savedSquads.map(squad => /*#__PURE__*/React.createElement("div", {
    key: squad.id,
  ...
  }, squad.name, " (", squad.data.length, " players)"), /*#__PURE__*/React.createElement("div", {
    className: "flex space-x-1"
  }, /*#__PURE__*/React.createElement("button", {
    onClick: () => handleLoadSquad(squad.data),
    ...
    className: "text-xs px-2 py-1 rounded-full text-white bg-red-500"
  }, "Del"))))))), /*#__PURE__*/React.createElement("div", {
    className: "lg:col-span-2 space-y-6"
  }, /*#__PURE__*/React.createElement("div", {
    className: "p-6 rounded-xl shadow-2xl bg-white"
  }, /*#__PURE__*/React.createElement("h2", {
    className: "text-2xl font-bold mb-4 flex items-center",
    style: {
      color: COLORS.NAVY_BLUE
    ...
    className: "w-6 h-6 mr-2"
  }), " Player Roster"), /*#__PURE__*/React.createElement("div", {
    className: "max-h-96 overflow-y-auto"
  }, displayedPlayers.map((player, index) => /*#__PURE__*/React.createElement(PlayerInputRow, {
    key: player.id,
    player: player,
    index: index,
    settings: settings,
  ...
  }, "Plan Options"), /*#__PURE__*/React.createElement("div", {
    ...
    className: "mr-2"
  }), " Automatic (Equal Minutes)"), /*#__PURE__*/React.createElement("label", {
    className: `flex items-center font-medium ${isPremiership ? '' : 'opacity-50 cursor-not-allowed'}`,
    style: {
      color: COLORS.NAVY_BLUE
    }
  }, /*#__PURE__*/React.createElement("input", {
    ...
    onChange: () => isPremiership && setSettings(p => ({
      ...p,
      planType: 'Manual'
    })),
    className: "mr-2",
    disabled: !isPremiership
  }), " Manual Plan ", isPremiership ? '' : '(Premiership Only)')), settings.planType === 'Automatic' && /*#__PURE__*/React.createElement("div", {
    className: `grid grid-cols-3 gap-4 p-4 rounded-lg border-dashed border ${isPremiership ? '' : 'opacity-50 pointer-events-none bg-gray-50'}`,
    style: {
      borderColor: COLORS.NAVY_BLUE
    }
  }, /*#__PURE__*/React.createElement("p", {
    className: `col-span-3 text-sm font-semibold mb-2 ${isPremiership ? 'text-gray-700' : 'text-orange-500'}`
  }, isPremiership ? 'Substitution Frequency (Premiership)' : 'Upgrade to Premiership for Sub Control'), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "block text-sm font-medium",
    style: {
      color: COLORS.NAVY_BLUE
    }
  }, "Interval (min)"), /*#__PURE__*/React.createElement("select", {
    value: settings.subInterval,
    onChange: e => setSettings(p => ({
      ...p,
      subInterval: parseInt(e.target.value, 10)
    })),
    ...
    disabled: !isPremiership
  }, [5, 8, 10, 15].map(v => /*#__PURE__*/React.createElement("option", {
    key: v,
    value: v
  ...
  }, "First Sub (min)"), /*#__PURE__*/React.createElement("select", {
    value: settings.firstSubTime,
    onChange: e => setSettings(p => ({
      ...p,
      firstSubTime: parseInt(e.target.value, 10)
    })),
    className: "w-full p-2 rounded-lg text-sm",
    style: {
      backgroundColor: COLORS.WHITE,
  ...
  }, "Max Subs (#)"), /*#__PURE__*/React.createElement("select", {
    value: settings.maxSubs,
    onChange: e => setSettings(p => ({
      ...p,
      maxSubs: parseInt(e.target.value, 10)
    })),
    className: "w-full p-2 rounded-lg text-sm",
    style: {
      backgroundColor: COLORS.WHITE,
    ...
    disabled: !isPremiership
  }, [1, 2, 3, 4].map(v => /*#__PURE__*/React.createElement("option", {
    key: v,
    value: v
  ...
  }, isGenerating ? /*#__PURE__*/React.createElement(Loader2, {
    className: "w-5 h-5 animate-spin mr-2"
  }) : /*#__PURE__*/React.createElement(Play, {
    className: "w-5 h-5 mr-2"
  }), isGenerating ? 'Generating...' : 'Generate Match Plan')))), /*#__PURE__*/React.createElement("div", {
    className: "mt-8"
  }, /*#__PURE__*/React.createElement("h2", {
  ...
  }, "Match Plan Output"), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-1 lg:grid-cols-2 gap-8"
  }, /*#__PURE__*/React.createElement("div", {
    className: "p-6 rounded-xl shadow-xl bg-gray-50"
  }, /*#__PURE__*/React.createElement("h3", {
  ...
  }, "Substitution Schedule"), /*#__PURE__*/React.createElement("pre", {
    className: "whitespace-pre-wrap font-mono text-sm leading-relaxed",
    style: {
      color: COLORS.NAVY_BLUE
    }
  }, matchPlan || 'Press "Generate Match Plan" to see the schedule here. Match info will display the selected periods for 5v5.')), /*#__PURE__*/React.createElement("div", {
  ...
  }, "Starting Formation Visual"), settings.selectedFormation && /*#__PURE__*/React.createElement(PositionVisualizer, {
    settings: settings,
...
// Ensure Firebase dependencies are available in Canvas environment
